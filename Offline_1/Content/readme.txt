To get a better understanding of http request & responses, you can watch the following video:
https://www.youtube.com/watch?v=eesqK59rhGA

You must learn the structure of http request/responses along with the headers for this assignment. You may go through the slide "HTTP" to get the generic concept of HTTP. You can also google "HTTP Request" or "HTTP Response" for a better understanding.

You should also develop a good understanding of MIME Type for this assignment. 
